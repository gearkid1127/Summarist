...
import AudioDuration from "@/app/components/books/AudioDuration";
            ...
            <div className={styles["inner-book__wrapper"]}>
              <div className={styles["inner-book__description--wrapper"]}>
                ...
                <div className={styles["inner-book__description"]}>
                  ...
                  <div className={styles["inner-book__duration"]}><AudioDuration audioLink={book.audioLink}/></div>
                </div>
                <div className={styles["inner-book__description"]}>
                  <div className={styles["inner-book__icon"]}>
                    <svg
                  ...
                  <div className={styles["inner-book__type"]}>{book.type}</div>
                </div>
                <div className={styles["inner-book__description"]}>
                  <div className={styles["inner-book__icon"]}>
                    <svg
