...
export default function forYou({ book }: BookCardProps) {
  ...
  const selectedBook =
    !selectedLoading && selectedBooks.length > 0 ? selectedBooks[0] : null;
      ...
      <div className={styles.container}>
        <div className={styles.foryou__wrapper}>
          ...
          {selectedLoading ? (
            <div className={`${styles.selected__book} ${styles.skeletonCard}`}>
              ...
              <div className={styles.selected__bookcontent}>
                <div
                  className={`${styles.skeletonBlock} ${styles.skeletonImg}`}
                />
                <div className={styles.selectedbook__text}>
                  ...
                  />
                  <div
                    className={`${styles.skeletonBlock} ${styles.skeletonMeta}`}
                  />
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className={styles.foryou__subtitle}>Browse these books</div>
